...
ElasticMapReduceClusterJobFlowInstancesConfig.prototype = {
	 ...
	 */
	additionalMasterSecurityGroups: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	additionalSlaveSecurityGroups: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	coreInstanceGroup: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	emrManagedMasterSecurityGroup: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	emrManagedSlaveSecurityGroup: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	masterInstanceGroup: function(value) {
	 ...
	 * @return {ElasticMapReduceClusterJobFlowInstancesConfig}
	 */
	serviceAccessSecurityGroup: function(value) {

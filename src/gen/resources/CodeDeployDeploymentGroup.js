 ...
 * @constructor
 */
function CodeDeployDeploymentGroup(name, initialData) {
	if (!name) {
...
CodeDeployDeploymentGroup.prototype = {
	 ...
	 * @return {CodeDeployDeploymentGroup}
	 */
	autoScalingGroups: function(value) {
	 ...
	 * Update requires: No interruption
	 *
	 * @param {AWSCodeDeployDeploymentGroupDeployment} value
	 * @return {CodeDeployDeploymentGroup}
	 */
	deployment: function(value) {
	 ...
	 * @return {CodeDeployDeploymentGroup}
	 */
	deploymentGroupName: function(value) {
	 ...
	 * Update requires: No interruption
	 *
	 * @param {AWSCodeDeployDeploymentGroupEc2TagFilters} value
	 * @return {CodeDeployDeploymentGroup}
	 */
	ec2TagFilters: function(value) {
	 ...
	 * Update requires: No interruption
	 *
	 * @param {AWSCodeDeployDeploymentGroupOnPremisesInstanceTagFilters} value
	 * @return {CodeDeployDeploymentGroup}
	 */
	onPremisesInstanceTagFilters: function(value) {

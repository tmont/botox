 ...
 * @constructor
 */
function RDSDBInstance(name, initialData) {
	if (!name) {
...
RDSDBInstance.prototype = {
	 ...
	 */
	allocatedStorage: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	allowMajorVersionUpgrade: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	characterSetName: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbclusterIdentifier: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbinstanceClass: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbinstanceIdentifier: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbparameterGroupName: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbsecurityGroups: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	dbsnapshotIdentifier: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	optionGroupName: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	sourceDBInstanceIdentifier: function(value) {
	 ...
	 * @return {RDSDBInstance}
	 */
	vpcsecurityGroups: function(value) {
	...
	attr: function() {
		throw new Error('AWS::RDS::DBInstance has no attributes');
	},
